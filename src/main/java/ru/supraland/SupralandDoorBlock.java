...
public class SupralandMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        // Add to creative tab
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS, entries -> {
        ...
        // Register all upgrade chest variants as items
        for (UpgradeType type : UpgradeType.values()) {
            ...
            ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS, e -> e.add(chestItem));
        }
